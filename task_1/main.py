...
def perform_task():
    ...
    while not stop_flag:
        ...
        if 'wikipedia' in query:
            speak('Opening Wikipedia in the browser...')
            query = query.replace("wikipedia", "").strip()  # Remove 'wikipedia' and any extra spaces
            ...
            webbrowser.open("https://github.com/ansariparvej")
        elif 'open linkedin' in query:
            webbrowser.open("https://www.linkedin.com/in/ansariparvej/")
        elif 'open notepad' in query:
            webbrowser.open("/snap/bin/subl")
            ...
            code_path = "/home/ali/anaconda3/Coding Playground/Voice_Assistant/main.py"
...
def main():
    ...
    background_image = Image.open(
        "img_1.jpg")  # Replace "path/to/your/background_image.jpg" with the actual image file path
    ...
    image2 = Image.open("img_2.jpg")  # Replace "path_to_image2.jpg" with the actual path to your image
